      ...
      <>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-5">
            <input type="text" name='brewery' id={`brewery${beer.id}`} className="form-control" value={beer.brewery} onChange={handleItemChange} />
          </div>
          <label htmlFor={`beerName${beer.id}`} className="col-sm-1 col-form-label">Beer Name</label>
          <div className="col-sm-5">
            <input type="text" name='beerName' id={`beerName${beer.id}`} className="form-control" value={beer.beerName} onChange={handleItemChange} />
          </div>
        </div>
        <div className="form-group row">
          <label htmlFor={`abv${beer.id}`} className="col-sm-1 col-form-label">Abv</label>
          <div className="col-sm-3">
            <input type="text" name='abv' id={`abv${beer.id}`} className="form-control" value={beer.abv} onChange={handleItemChange} />
          </div>
          <label htmlFor={`state${beer.id}`} className="col-sm-1 col-form-label">State</label>
          <div className="col-sm-3">
            <input type="text" name='state' id={`state${beer.id}`} className="form-control" value={beer.state} onChange={handleItemChange} />
          </div>
          <label htmlFor={`ounces${beer.id}`} className="col-sm-1 col-form-label">Ounces</label>
          <div className="col-sm-3">
            <input type="text" name='ounces' id={`ounces${beer.id}`} className="form-control" value={beer.ounces} onChange={handleItemChange} />
          </div>
        </div>
        <br /><br />
      </>
